<script lang="ts">
  ...
  export let onAnswer: (confirmed: boolean) => void;
  export let title = "Start Streaming";
  export let message = "Do you want to start streaming now?";
  export let ariaLabel = "Start streaming confirmation";
  export let confirmLabel = "Yes";
  export let cancelLabel = "No";

  let cancelBtnEl: HTMLButtonElement | null = null;
  let confirmBtnEl: HTMLButtonElement | null = null;
  let focusConfirm = true;
  let wasOpen = false;
